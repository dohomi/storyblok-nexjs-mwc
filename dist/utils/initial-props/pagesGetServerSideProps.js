...
var pagesGetServerSideProps = function (props) { return __awaiter(void 0, void 0, void 0, function () {
    var query, req, hostname, host, slug, pageProps, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = props.query, req = props.req;
                hostname = '';
                if (req) {
            ...
            case 1:
                ...
                slug = (query === null || query === void 0 ? void 0 : query.index) || 'home';
                console.log('pagesGetServerSideProps', hostname, slug);
                StoryblokService.setDevMode();
                StoryblokService.setQuery(query);
                return [4 /*yield*/, getPageProps(slug, hostname)];
            case 2:
                pageProps = _a.sent();
                endMeasureTime();
                return [2 /*return*/, {
