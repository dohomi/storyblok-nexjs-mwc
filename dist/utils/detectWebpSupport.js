...
var hasWebpSupport = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supportsWebP, can;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!req) return [3 /*break*/, 1];
                // we set this and calling it in _document to set global windows variable
                return [2 /*return*/, !!(req.headers.accept && req.headers.accept.includes('webp'))];
            case 1:
