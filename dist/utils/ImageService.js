...
export function getImageAttrs({ originalSource, width = 0, height = 0, filter = '', fitInColor, smart, focalPoint }) {
...
const boundCoordinate = (value, upperBound) => {
...
export function getFocalPoint(src, focalPoint) {
    ...
    const top = boundCoordinate((focalPointY / 100) * height - FOCAL_SQUARE_LENGTH / 2, height);
    const left = boundCoordinate((focalPointX / 100) * width - FOCAL_SQUARE_LENGTH / 2, width);
