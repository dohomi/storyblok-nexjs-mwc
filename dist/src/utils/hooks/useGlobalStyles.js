...
export const getCreatedStyles = (theme) => {
    const genSpacing = (breakpoint = '') => {
        const spacing = {};
    ...
    const dark = '#303030';
    return createStyles({
        '@global': Object.assign(Object.assign(Object.assign({}, getNprogressJss(theme)), genSpacing()), { '.img-fluid': {
                maxWidth: '100%',
                height: 'auto'
            }, 'a': {
                textDecoration: 'none'
            ...
            '.mh-100': {
                ...
                '.d-xs-block': {
            ...
            }, [theme.breakpoints.up('sm')]: Object.assign({ '.d-sm-inline-flex': {
                    display: 'inline-flex'
                }, '.d-sm-none': {
                    display: 'none'
                }, '.d-sm-block': {
                    ...
                    textAlign: 'justify'
                } }, genSpacing('-sm')), [theme.breakpoints.up('md')]: Object.assign({ '.d-md-inline-flex': {
                    display: 'inline-flex'
                }, '.d-md-none': {
                    display: 'none'
                }, '.d-md-block': {
                    ...
                    textAlign: 'justify'
                } }, genSpacing('-md')), [theme.breakpoints.up('lg')]: {
                '.d-lg-inline-flex': {
                    display: 'inline-flex'
                },
                '.d-lg-none': {
