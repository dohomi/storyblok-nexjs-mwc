...
const RichTextParagraph = ({ content }) => {
    ...
    return (React.createElement(SbEditable, { content: content },
        React.createElement(Typography, { className: clsx('lm-markup', classes.richText, content.style, content.class_names && content.class_names.values, {
            ...
            }), align: content.align ? content.align : undefined, color: content.color ? content.color : undefined, component: "div", style: {
            ...
            }, variant: mapTypographyVariant[content.typography ? content.typography : 'body1'] }, content.body && content.body.content.map((blok, i) => RteContentRender(blok, i)))));
};
