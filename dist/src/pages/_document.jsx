            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __assign({}, initialProps)];
                }
            });
        });
    };
    MyDocument.prototype.render = function () {
        var injectBodyScript = {
        ...
        var GTM = !StoryblokService.insideVisualComposer() && getGoogleTagManager();
        var contentLanguage = DeviceDetectService.getLanguage();
        var htmlProps = {};
        if (contentLanguage) {
      ...
      {GTM && (<noscript>
          <iframe src={"https://www.googletagmanager.com/ns.html?id=" + process.env.GTM_CONTAINER} height="0" width="0" style={{ display: 'none', visibility: 'hidden' }}></iframe>
        </noscript>)}
      <Main />
      <script dangerouslySetInnerHTML={injectBodyScript}></script>

      <NextScript />
      {GTM && (<script dangerouslySetInnerHTML={GTM}></script>)}
      </body>
      </html>);
    };
    return MyDocument;
