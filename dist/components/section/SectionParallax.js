...
var SectionParallax = function (_a) {
    ...
    var _b = useInView(intersectionDefaultOptions), refIntersectionObserver = _b[0], inView = _b[1], refElement = _b[2];
    var width = dimensions.width;
    var height = dimensions.height;
    var elements = content.elements || [];
    var contentHeight = content.height;
    var _c = useState(), layers = _c[0], setLayers = _c[1];
    ...
    return (React.createElement(SbEditable, { content: content },
        React.createElement("div", { className: classes.parallax, style: styles, ref: refIntersectionObserver },
            React.createElement(ParallaxBanner, { disabled: false, style: styles, layers: layers || [] },
                ...
                React.createElement("div", { className: clsx('parallax__content', content.class_names && content.class_names.values) }, body.map(function (blok) { return Components(blok); }))))));
};
