...
const LmAvatar = ({ content }) => {
    ...
    const [imageAttrs, setImageSrc] = useState({});
    const style = {
    ...
    return (React.createElement(SbEditable, { content: content },
        React.createElement(Avatar, Object.assign({ ref: refIntersectionObserver, variant: content.variant || 'circle', style: style, className: clsx(content.class_names && content.class_names.values) }, imageAttrs),
            content.letter,
